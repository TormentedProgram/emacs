...
this repo is using a ton of hacky stuff to make emacs more usable for me specifically
it's poorly managed and is in need of a major redo but it works for me for now
